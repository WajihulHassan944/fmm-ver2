  ...
  return <>
    ...
    <div className="pw-admin-page">
      <section className="pw-admin-hero">
        ...
        <aside><img src="/images/pro-wrestling/pro-wrestling-hero.jpg" alt="Pro Wrestling arena" /><span><small>Backend mode</small><strong>PRO_WRESTLING</strong><em>Full-match predictions</em></span></aside>
      </section>
