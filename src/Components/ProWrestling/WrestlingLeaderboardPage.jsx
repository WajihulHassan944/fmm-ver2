      ...
      <div className="pw-page pw-leaderboard-page">
        <section className="pw-leaderboard-hero">
          <div className="theme-container">
            ...
            <div className="pw-leaderboard-hero-copy"><p>FANTASY MMADNESS Pro Wrestling</p><h1>The action decides. <span>The leaderboard remembers.</span></h1><div><WrestlingStatusBadge status={match.status} /><span><FaCrown /> Winner: {winnerLabel(match.officialWinner, match)}</span><span><FaCoins /> {formatTokenAmount(match.currentPot)} FM COINS pot</span></div></div>
