...
export const DEFAULT_OG_IMAGE = `${SITE_URL}/images/social/fantasy-mmadness-link-cover-final.png`;
...
export const SEO_ROUTE_MAP = {
  '/': {
    ...
    image: `${SITE_URL}/images/social/fantasy-mmadness-link-cover-final.png`,
  },
  '/home': {
