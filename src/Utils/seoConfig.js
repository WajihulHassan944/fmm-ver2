...
export const DEFAULT_OG_IMAGE = `${SITE_URL}/images/fmm-pages/premium-duel-banner.png`;
...
export const SEO_ROUTE_MAP = {
  '/': {
    ...
    image: `${SITE_URL}/images/fmm-experience/homepage-fight-hero.jpg`,
  },
  '/home': {
  ...
  '/fantasy-kickboxing': {
    ...
    image: `${SITE_URL}/images/fmm-pages/premium-arena-banner.png`,
  },
  '/fantasy-bare-knuckle': {
    ...
    image: `${SITE_URL}/images/fmm-pages/premium-duel-banner.png`,
  },
  '/fantasy-pro-wrestling': {
    ...
    image: `${SITE_URL}/images/pro-wrestling/pro-wrestling-hero.jpg`,
  },
  ...
  '/guides/pro-wrestling-scoring': {
    ...
    image: `${SITE_URL}/images/pro-wrestling/wrestling-live-premium.jpg`,
  },
  '/upcomingfights': {
  ...
  '/pro-wrestling/history': {
    ...
    image: `${SITE_URL}/images/pro-wrestling/wrestling-history-premium.jpg`,
  },
  '/playforfree': {
...
export const getSeoConfigForPath = (path = '/') => {
  ...
  if (clean.startsWith('/wrestlers/')) {
    return {
      ...
      image: `${SITE_URL}/images/pro-wrestling/wrestling-roster-premium.jpg`,
      path: clean,
    };
  }
  ...
  if (clean.startsWith('/pro-wrestling/matches/')) {
    return {
      ...
      image: `${SITE_URL}/images/pro-wrestling/wrestling-match-premium.jpg`,
      path: clean,
    };
  }
...
export const buildOrganizationSchema = () => ({
  ...
  name: SITE_NAME,
  url: SITE_URL,
  logo: `${SITE_URL}/images/fmm-experience/fantasy-mmadness-logo.png`,
  sameAs: [
