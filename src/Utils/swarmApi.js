...
const CORE_JOB_TYPES = [
  ...
  ['content.upcoming-event-preview', 'Upcoming event preview blog', 'content', ['combat']],
  ...
  ['content.pro-wrestling-result-recap', 'Pro-wrestling match recap', 'content', ['pro_wrestling']],
  ['content.contest-rules-explainer', 'Contest rules / explainer', 'content', ['combat', 'pro_wrestling']],
  ['content.newsletter-draft', 'Email / newsletter draft', 'content', ['combat', 'pro_wrestling']],
  ['media.image-prompt', 'Image prompt generation', 'media', ['combat', 'pro_wrestling']],
  ['content.faq', 'FAQ generation', 'content', ['combat', 'pro_wrestling']],
  ['content.how-to-play', 'How-to-play content suggestion', 'content', ['combat', 'pro_wrestling']],
  ...
  ['seo.weekly-traffic-opportunity', 'Weekly traffic opportunity report', 'seo', ['combat', 'pro_wrestling']],
  ...
  ['seo.missing-meta-detector', 'Missing metadata detector', 'seo', ['combat', 'pro_wrestling']],
  ...
  ['seo.canonical-checks', 'Canonical URL checks', 'seo', ['combat', 'pro_wrestling']],
  ['seo.opengraph-twitter-cards', 'OpenGraph / Twitter card', 'seo', ['combat', 'pro_wrestling']],
  ['seo.fight-event-structured-data', 'Fight/event structured data', 'seo', ['combat']],
  ['seo.fighter-wrestler-structured-data', 'Wrestler/fighter structured data', 'seo', ['combat', 'pro_wrestling']],
  ...
  ['social.instagram-post-draft', 'Instagram post draft', 'social', ['combat', 'pro_wrestling']],
  ['social.facebook-post-draft', 'Facebook post draft', 'social', ['combat', 'pro_wrestling']],
  ['social.event-promotional-posts', 'Promotional social posts', 'social', ['combat', 'pro_wrestling']],
  ['social.result-post', 'Result social post', 'social', ['combat', 'pro_wrestling']],
  ['social.contest-reminder', 'Reminder social post', 'social', ['combat', 'pro_wrestling']],
  ['social.winners-announcement', 'Winners announcement', 'social', ['combat', 'pro_wrestling']],
  ['social.youtube-caption-draft', 'YouTube/social caption draft', 'social', ['combat', 'pro_wrestling']],
  ['social.discord-announcement-draft', 'Discord announcement draft', 'social', ['combat', 'pro_wrestling']],
  ['social.calendar', 'Social content calendar', 'social', ['combat', 'pro_wrestling']],
  ['notification.traffic-issues', 'Admin traffic notification', 'notification', ['combat', 'pro_wrestling']],
  ['data.external-candidate', 'External data candidate', 'data', ['combat', 'pro_wrestling']],
  ['data.trending-mma-topics', 'Trending MMA topic finder', 'data', ['combat']],
  ['data.trending-wrestling-topics', 'Trending pro-wrestling topic finder', 'data', ['pro_wrestling']],
  ['content.calendar', 'Content calendar', 'content', ['combat', 'pro_wrestling']],
  ['automation.draft-queue-generation', 'Draft queue generation', 'automation', ['combat', 'pro_wrestling']],
  ['seo.competitor-gap-report', 'Competitor/content gap report', 'seo', ['combat', 'pro_wrestling']],
  ['analytics.traffic-growth-dashboard', 'Traffic opportunity report', 'analytics', ['combat', 'pro_wrestling']],
  ['content.homepage-feature', 'Homepage featured content plan', 'content', ['combat', 'pro_wrestling']],
  ['analytics.leaderboard-summary', 'Leaderboard summary', 'analytics', ['combat', 'pro_wrestling']],
  ...
  ['automation.settings-export', 'Automation settings export', 'automation', ['combat', 'pro_wrestling']],
  ['notification.failed-automations', 'Failed automation report', 'notification', ['combat', 'pro_wrestling']],
  ['automation.failed-job-retry-plan', 'Failed-job retry plan', 'automation', ['combat', 'pro_wrestling']],
  ['analytics.agent-performance', 'Agent performance dashboard', 'analytics', ['combat', 'pro_wrestling']],
  ['content.user-dashboard-opportunities', 'User dashboard fight opportunities', 'content', ['combat', 'pro_wrestling']],
  ['analytics.user-growth-1000-plan', '1000-new-users growth plan', 'analytics', ['combat', 'pro_wrestling']],
  ...
  ['data.fight-calendar-refresh', 'Fight schedule calendar refresh', 'data', ['combat', 'pro_wrestling']],
